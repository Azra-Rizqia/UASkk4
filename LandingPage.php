...
<body>
   ...
   <header>
      ...
      <div class="main">
         <a class="user" href="register.php"><button>Sign In</button></a>
   ...
   <div class="container">
      ...
      <div class="hello">
         <div class="text">
            <div class="txt">
               <h1>Discover Digital Artworks and Collect Amazing NFTs</h1>
               <p>Show your unique taste to the world and collect NFT from the best artists.</p>
               </div>
               <a href="login.php"><button class="btnstart col-md-4">Get Started</button></a>
            </div>
            <div class="img">
               <img src="ASET/pict1.png" alt="" >
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="trend">
    ...
    <div class="footer">
        ...
        <div class="link-nav">
            ...
            <li><a href="#category">Category</a></li>
            <li><a href="#community">Community</a></li>
            <li><a href="login.php">Created</a></li>
        </div>
        <div class="forms">
            <h3>Stay With US.</h3>
            <form action="">
